...
public class C08_JSONObjectVerileriCagirma {
   ...
   /*
    ...
    public void jsonPath01(){
        ...
        /*
        NOT:
        Sadece get methodunu kullanirsak onun sonrasinda baska bir method cagiramayiz.
        Onun yerine oncelikle getJSON objesi kullanilirsa sonrasinda get methodu kullanilabilir.

       JSON objesi uzerinden arraylere indexler uzerinden ulasilir!!!
