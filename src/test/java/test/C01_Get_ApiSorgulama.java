...
public class C01_Get_ApiSorgulama {
    ...
    public void get01(){
        ...
        Response response= given().when().get(url);// given restassured kutuphanesinden import edilmeli!!

        response.prettyPrint(); //yazdirma islemi icin prettyPrint kullanilir
        ...
        System.out.println("Response Suresi : " + response.getTime());//1963
